...
if save:
    ...
    np.savetxt('O4_' + str(nobs_new) + '_pars_min.txt', pars_min)
    np.savetxt('O4_' + str(nobs_new) + '_pars_max.txt', pars_max)
    
    x_rate = np.log10(rate_trainset) # Observable. Input data.
    x_min_rate = np.min(x_rate, axis = 0)
    x_max_rate = np.max(x_rate, axis = 0)
    np.savetxt('O4_' + str(nobs_new) + '_rate_minmax.txt', np.asarray([x_min_rate, x_max_rate]))
    ...
    np.savetxt('O4_' + str(nobs_new) + '_drate_min.txt', x_min_drate)
    np.savetxt('O4_' + str(nobs_new) + '_drate_max.txt', x_max_drate)
    ...
    np.savetxt('O4_' + str(nobs_new) + '_s1s2_min.txt', x_min_s1s2)
    np.savetxt('O4_' + str(nobs_new) + '_s1s2_max.txt', x_max_s1s2)
    with h5py.File('testset_O4_' + str(nobs_new) + '.h5', 'w') as data:
        ...
        data.create_dataset('s1s2_testset', data = s1s2_testset[:,:-1,:-1].reshape(len(s1s2_testset),1,96,96))
    ...
    pars_min = np.loadtxt('O4_' + str(nobs_new) + '_pars_min.txt')
    pars_max = np.loadtxt('O4_' + str(nobs_new) + '_pars_max.txt')
    x_minmax_rate = np.loadtxt('O4_' + str(nobs_new) + '_rate_minmax.txt')
    x_min_rate = x_minmax_rate[0]
    x_max_rate = x_minmax_rate[1]
    x_min_drate = np.loadtxt('O4_' + str(nobs_new) + '_drate_min.txt')
    x_max_drate = np.loadtxt('O4_' + str(nobs_new) + '_drate_max.txt')
    #x_min_s1s2 = np.loadtxt('O4_' + str(nobs_new) + '_s1s2_min.txt')
    x_max_s1s2 = np.loadtxt('O4_' + str(nobs_new) + '_s1s2_max.txt')
...
if fit:
    ...
    plt.tight_layout()
    plt.savefig('../graph/O4_' + str(nobs_new) + '_Coverage_rate.pdf')
...
if fit:
    ...
    for i in range(3):
        swyft.plot_zz(coverage_samples, "pars_norm[%i]"%i, ax = axes[i])
    plt.tight_layout()
    plt.savefig('../graph/O4_' + str(nobs_new) + '_Coverage_drate.pdf')
...
if fit:
    ...
    for i in range(3):
        swyft.plot_zz(coverage_samples, "pars_norm[%i]"%i, ax = axes[i])
    plt.tight_layout()
    plt.savefig('../graph/O4_' + str(nobs_new) + '_Coverage_s1s2.pdf')

# # Plots


# +
nobs_list       = [1000 , 2000 , 3000 , 4000 , 5000 , 6000 , 7000 , 8000 , 9000 , 10000, 12000, 15000, 20000]
             
rate_valLoss    = [-0.82, -1.02, -1.1 , -1.12, -1.06, -1.25, -1.1 , -1.09, -1.13, -1.09, -1.08, -1.15, -1.1 ]
rate_trainLoss  = [-3.34, -1.94, -0.81, -2.69, -0.84, -1.14, -3.26, -1.29, -1.51, -3.79, -1.31, -1.78, -2.48]

drate_valLoss   = [-0.77, -1.09, -1.19, -1.21, -1.49, -1.64, -1.67, -1.77, -1.64, -1.7 , -1.73, -1.83, -1.84]
drate_trainLoss = [-6.3 , -3.81, -3.49, -6.05, -2.8 , -2.15, -5.49, -4.33, -2.67, -6.98, -4.44, -2.91, -5.0 ]

s1s2_valLoss    = [-1.07, -1.64, -1.77, -1.73, -1.8 , -1.96, -1.73, -1.91, -1.86, -2.0 , -1.88, -2.03, -1.9 ]
s1s2_trainLoss  = [-4.7 , -4.47, -1.87, -5.24, -3.07, -3.12, -5.92, -4.48, -2.22, -6.44, -3.63, -2.79, -4.58]
# -
...
plt.ylabel('Val Loss')
plt.xlabel('# data')
plt.savefig('../graph/O4_datavsValloss.pdf')
