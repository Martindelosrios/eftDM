...
10**np.min(pars_trainset,axis = 0)

10**np.max(pars_trainset,axis = 0)
...
# ---------------------------------------------- 
# It converges to val_loss = -1.38 in testset
# ---------------------------------------------- 
# -
...
sbn.kdeplot(cross_sec_int_prob_sup_rate_0, label = '$\\theta = 0$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_rate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_rate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_rate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_rate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[0,0])
ax[0,0].legend()
ax[0,0].set_xlabel('$\int_{\sigma_{th}}^{\inf} P(\sigma|x)$')
ax[0,0].set_title('Total Rate')

sbn.kdeplot(masses_int_prob_sup_rate_0, label = '$\\theta = 0$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_rate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_rate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_rate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_rate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[0,1])
ax[0,1].legend()
ax[0,1].set_xlabel('$\int_{m_{min}}^{m_{max}} P(m_{DM}|x)$')
ax[0,1].set_title('Total Rate')

sbn.kdeplot(masses_prob_sup_rate_0, label = '$\\theta = 0$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_rate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_rate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_rate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_rate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[1,0])
ax[1,0].legend()
ax[1,0].set_xlabel('$\int_{m_{min}}^{\inf} P(m_{DM}|x)$')

sbn.kdeplot(masses_prob_inf_rate_0, label = '$\\theta = 0$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_rate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_rate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_rate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_rate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[1,1])
ax[1,1].legend()
...
plt.savefig('../graph/O4_contours_rate.pdf')
...
plt.savefig('../graph/O4_contours_rate_int_prob.pdf')
...
M_prob_sup_0_rate             = gaussian_filter(masses_prob_sup_rate_0, sigma)
M_prob_inf_0_rate             = gaussian_filter(masses_prob_inf_rate_0, sigma)
...
M_prob_sup_pi_2_rate          = gaussian_filter(masses_prob_sup_rate_pi_2, sigma)
M_prob_inf_pi_2_rate          = gaussian_filter(masses_prob_inf_rate_pi_2, sigma)
...
M_prob_sup_pi_4_rate          = gaussian_filter(masses_prob_sup_rate_pi_4, sigma)
M_prob_inf_pi_4_rate          = gaussian_filter(masses_prob_inf_rate_pi_4, sigma)
...
M_prob_sup_mpi_2_rate         = gaussian_filter(masses_prob_sup_rate_mpi_2, sigma)
M_prob_inf_mpi_2_rate         = gaussian_filter(masses_prob_inf_rate_mpi_2, sigma)
...
M_prob_sup_mpi_4_rate         = gaussian_filter(masses_prob_sup_rate_mpi_4, sigma)
M_prob_inf_mpi_4_rate         = gaussian_filter(masses_prob_inf_rate_mpi_4, sigma)

# +
levels = [0.56, 0.76, 0.84, 0.9, 1]
...
ax[0,0].set_xscale('log')
ax[0,0].grid(which='both')
ax[0,0].text(3e2, 1e-36, '$\\theta = \pi/2$')
ax[0,0].plot(masses, rate_90_CL_pi2[2,:], color = 'black', linestyle = '-.', label = 'Bin. Lik. [90%]')
ax[0,0].legend(loc = 'lower left')
...
ax[0,1].contour(m_vals, cross_vals, M_int_prob_sup_pi_4_rate.reshape(30,30).T, levels=levels, linewidths = 2, cmap = 'inferno', linestyles = [':'])
...
ax[0,1].grid(which='both')
ax[0,1].text(3e2, 1e-36, '$\\theta = \pi/4$')
...
ax[1,0].contour(m_vals, cross_vals, M_int_prob_sup_mpi_2_rate.reshape(30,30).T, levels=levels, linewidths = 2, cmap = 'inferno', linestyles = [':'])
...
ax[1,0].grid(which='both')
ax[1,0].text(3e2, 1e-36, '$\\theta = -\pi/2$')
...
ax[1,1].contour(m_vals, cross_vals, M_int_prob_sup_0_rate.reshape(30,30).T, levels=levels, linewidths = 2, cmap = 'inferno', linestyles = [':'])
...
plt.scatter(x = pars_slices[rec_ind,1], y = rate_cross_sec_sigmas[rec_ind,6], c = rate_cross_sec_int_prob_sup[rec_ind], zorder=5) 
plt.plot([-45,-34], [-45,-34])
plt.xlim(-42,-34)
plt.ylim(-42,-34)
plt.colorbar()
...
for folder in folders:
    ...
    if (os.path.exists(folder + 'cross_sec_sigmas_drate.txt') &
        ...
        for itest in range(len(pars_norm)):
...
sbn.kdeplot(cross_sec_int_prob_sup_drate_0, label = '$\\theta = 0$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_drate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_drate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_drate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[0,0])
sbn.kdeplot(cross_sec_int_prob_sup_drate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[0,0])
ax[0,0].legend()
ax[0,0].set_xlabel('$\int_{\sigma_{th}}^{\inf} P(\sigma|x)$')
ax[0,0].set_title('Diff. Rate')

sbn.kdeplot(masses_int_prob_sup_drate_0, label = '$\\theta = 0$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_drate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_drate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_drate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[0,1])
sbn.kdeplot(masses_int_prob_sup_drate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[0,1])
ax[0,1].legend()
ax[0,1].set_xlabel('$\int_{m_{min}}^{m_{max}} P(m_{DM}|x)$')
ax[0,1].set_title('Diff. Rate')

sbn.kdeplot(masses_prob_sup_drate_0, label = '$\\theta = 0$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_drate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_drate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_drate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[1,0])
sbn.kdeplot(masses_prob_sup_drate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[1,0])
ax[1,0].legend()
ax[1,0].set_xlabel('$\int_{m_{min}}^{\inf} P(m_{DM}|x)$')

sbn.kdeplot(masses_prob_inf_drate_0, label = '$\\theta = 0$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_drate_pi_2, label = '$\\theta = \\frac{\pi}{2}$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_drate_pi_4, label = '$\\theta = \\frac{\pi}{4}$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_drate_mpi_2, label = '$\\theta = - \\frac{\pi}{2}$', ax = ax[1,1])
sbn.kdeplot(masses_prob_inf_drate_mpi_4, label = '$\\theta = - \\frac{\pi}{4}$', ax = ax[1,1])
ax[1,1].legend()
ax[1,1].set_xlabel('$\int_{0}^{m_{max}} P(m_{DM}|x)$')
...
M_prob_sup_0_drate             = gaussian_filter(masses_prob_sup_drate_0, sigma)
M_prob_inf_0_drate             = gaussian_filter(masses_prob_inf_drate_0, sigma)
...
M_prob_sup_pi_2_drate          = gaussian_filter(masses_prob_sup_drate_pi_2, sigma)
M_prob_inf_pi_2_drate          = gaussian_filter(masses_prob_inf_drate_pi_2, sigma)
...
M_prob_sup_pi_4_drate          = gaussian_filter(masses_prob_sup_drate_pi_4, sigma)
M_prob_inf_pi_4_drate          = gaussian_filter(masses_prob_inf_drate_pi_4, sigma)
...
M_prob_sup_mpi_2_drate         = gaussian_filter(masses_prob_sup_drate_mpi_2, sigma)
M_prob_inf_mpi_2_drate         = gaussian_filter(masses_prob_inf_drate_mpi_2, sigma)
...
M_prob_sup_mpi_4_drate         = gaussian_filter(masses_prob_sup_drate_mpi_4, sigma)
M_prob_inf_mpi_4_drate         = gaussian_filter(masses_prob_inf_drate_mpi_4, sigma)
...
if (os.path.exists(folder + 'test_cross_sec_sigmas_drate.txt') & 
    ...
    drate_cross_sec_sigmas = np.ones((len(pars_slices), 7))

    drate_cross_sec_int_prob     = np.ones(len(pars_norm)) * -99
    drate_cross_sec_int_prob_sup = np.ones(len(pars_norm)) * -99
    drate_masses_int_prob_sup    = np.ones(len(pars_norm)) * -99
    drate_masses_prob_sup        = np.ones(len(pars_norm)) * -99
    drate_masses_prob_inf        = np.ones(len(pars_norm)) * -99
...
plt.scatter(x = pars_slices[rec_ind,1], y = drate_cross_sec_sigmas[rec_ind,6], c = drate_cross_sec_int_prob_sup[rec_ind], zorder=5) 
plt.plot([-43,-34], [-43,-34])
plt.xlim(-41,-34)
plt.ylim(-41,-34)
plt.colorbar()
...
# ---------------------------------------
# Min val loss value -2.14  @ testset
# ---------------------------------------
...
for folder in folders:
    ...
    if (os.path.exists(folder + 'cross_sec_sigmas_s1s2.txt') & 
        ...
        for itest in tqdm(range(len(pars_norm))):
            ...
            print('$mass =$' + str(masses_int_prob_sup[itest]))
        ...
        masses_prob_sup_full.append(masses_prob_sup)
        masses_prob_inf_full.append(masses_prob_inf)
email('Termino analisis slices O4')
...
# +
levels = [0,0.1,0.16,0.24,0.32,0.7]
...
#plt.savefig('../graph/O4_contours_all_int_prob_sup.pdf')
...
# +
CR_int_prob_sup_pi_2_s1s2       = gaussian_filter(cross_sec_int_prob_sup_s1s2_pi_2, 0.01)
error = np.abs(cross_sec_sigmas_pi_2[:,0] - cross_sec_sigmas_pi_2[:,6])
plt.scatter(10**pars_slices[:,0], 10**pars_slices[:,1], c = cross_sec_int_prob_sup_s1s2_pi_2)
plt.colorbar()
...
plt.plot(masses, s1s2_90_CL_pi2[2,:], color = 'black', linestyle = ':', label = 'Bin. Lik. [90%]')
...
plt.scatter(x = pars_slices[rec_ind,1], y = s1s2_cross_sec_sigmas[rec_ind,6], c = s1s2_cross_sec_int_prob_sup[rec_ind], zorder=5) 
plt.plot([-42,-34], [-42,-34])
plt.xlim(-42,-34)
plt.ylim(-42,-34)
plt.colorbar()
        ...
        if (
            ...
            for itest in tqdm(range(len(pars_norm))):
                ...
                if plotCross & (itest in iplot):
                    if rate: plt.plot(parameter, np.exp(np.asarray(predictions_rate[0].logratios[:,par])[ind_sort]), color =color_rate, label = 'rate')
                    if drate: plt.plot(parameter, np.exp(np.asarray(predictions_drate[0].logratios[:,par])[ind_sort]), color =color_drate, label = 'drate')
                    if s1s2: plt.plot(parameter, np.exp(np.asarray(predictions_s1s2[0].logratios[:,par])[ind_sort]), color =color_s1s2, label = 's1s2')
                    
                    plt.plot(parameter, ratios, color ='black', ls = '--')

                    plt.axvline(x = pars_slices[itest, par])
                    plt.xlabel('$\\sigma$')
                    plt.ylabel('$P$')
                    plt.legend()
                    plt.savefig('../graph/O4_graph/CrossPosteriorsComb_' + flag + '_theta_' + theta + '_obs_' + str(itest) + '_folder_' + folder[-2:-1] + '_O4.pdf')
                    plt.clf()
                #-----------------------------------------------------------------------------------------------------------
                ...
                if plotMass & (itest in iplot):
                    ...
                    plt.ylabel('$P$')
                    plt.legend()
                    plt.savefig('../graph/O4_graph/MassPosteriorsComb_' + flag + '_theta_' + theta + '_obs_' + str(itest) + '_folder_' + folder[-2:-1] + '_O4.pdf')
                    plt.clf()
...
ax[0].set_yscale('log')
ax[0].set_xscale('log')
ax[0].text(0.7, 0.95, '$\\theta = \pi/2$', transform = ax[0].transAxes)
ax[0].legend(loc = 'lower left')

ax[1].fill_between(masses, s1s2_current_pi4[2,:], 1e-35, color = 'black', alpha = 0.2)

ax[1].text(0.7, 0.95, '$\\theta = \pi/4$', transform = ax[1].transAxes)

ax[2].fill_between(masses, s1s2_current_0[2,:], 1e-35, color = 'black', alpha = 0.2, label = 'Excluded')
ax[2].legend(loc = 'lower right')

ax[2].text(0.7, 0.95, '$\\theta = 0$', transform = ax[2].transAxes)
...
pars_slices, rate_slices, diff_rate_slices, s1s2_slices = read_slice(['../data/andresData/O4-fulldata/O4/theta-0/O4-slices01-0-v5/'])
...
# +
folders = ['../data/andresData/O4-fulldata/O4/theta-0/O4-slices01-0/',
           '../data/andresData/O4-fulldata/O4/theta-0/O4-slices01-0-v2/',
           '../data/andresData/O4-fulldata/O4/theta-0/O4-slices01-0-v3/',
           '../data/andresData/O4-fulldata/O4/theta-0/O4-slices01-0-v4/',
           '../data/andresData/O4-fulldata/O4/theta-0/O4-slices01-0-v5/'
         ]
...
bps = [11*30 + 10, 11*30 + 11, 11*30 + 12, 11*30 + 13]
...
ax[0,0].plot(cross_sec, ratios_s1s2_0[0,:], linestyle = linestyle[0], color = color_s1s2, label = 'S1-S2')
ax[0,1].plot(cross_sec, ratios_s1s2_0[1,:], linestyle = linestyle[0], color = color_s1s2)
ax[1,0].plot(cross_sec, ratios_s1s2_0[2,:], linestyle = linestyle[0], color = color_s1s2)
ax[1,1].plot(cross_sec, ratios_s1s2_0[3,:], linestyle = linestyle[0], color = color_s1s2)

ax[0,0].plot(cross_sec, ratios_drate_0[0,:], linestyle = linestyle[1], color = color_drate, label = 'Dif. Rate')
ax[0,1].plot(cross_sec, ratios_drate_0[1,:], linestyle = linestyle[1], color = color_drate)
ax[1,0].plot(cross_sec, ratios_drate_0[2,:], linestyle = linestyle[1], color = color_drate)
ax[1,1].plot(cross_sec, ratios_drate_0[3,:], linestyle = linestyle[1], color = color_drate)

ax[0,0].plot(cross_sec, ratios_rate_0[0,:], linestyle = linestyle[2], color = color_rate, label = 'Rate')
ax[0,1].plot(cross_sec, ratios_rate_0[1,:], linestyle = linestyle[2], color = color_rate)
ax[1,0].plot(cross_sec, ratios_rate_0[2,:], linestyle = linestyle[2], color = color_rate)
ax[1,1].plot(cross_sec, ratios_rate_0[3,:], linestyle = linestyle[2], color = color_rate)
...
plt.savefig('../graph/O4_graph/O4_PosteriorsExamples_fixSigma.pdf')
...
plt.savefig('../graph/O4_graph/O4_PosteriorsExamples_varSigma.pdf')
# -
